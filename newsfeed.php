...
<div class="user-dropdown" style="position: relative; display: inline-block;">
    ...
    <div id="user-menu" class="dropdown-content" style="display: none; position: absolute; right: 0; background-color: white; min-width: 120px; box-shadow: 0px 8px 16px rgba(0,0,0,0.2); z-index: 1;">
        <a href="profile.php" style="display: block; padding: 8px 16px; text-decoration: none; color: black;">Profile</a>
