...
<head>
  ...
  <title>About Us - DBCLM College</title>
...
// Fetch only the latest unread notification
  ...
  <section class="hero">
    ...
    <p>To curate and share thoughtful, high-quality articles that inform, inspire, and engage readers across diverse
      topics and perspectives.</p>
    ...
    <div class="caption-box">
      ...
      <p>We believe empowering creators to share their voice helps communities grow, bridging gaps and promoting
  ...
  <section class="cta">
    ...
    <p>We believe in helping talents to reach their fullest potential and creating opportunities for their growth and
      success.</p>
