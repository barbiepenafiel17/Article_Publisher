            ...
            <div class="notification-wrapper" style="position: relative;">
                ...
                <?php if ($notifCount > 0): ?>
                    <span class="notif-badge"
                        style="position:absolute; top:0; right:0; background:red; color:white; padding:2px 6px; border-radius:50%; font-size:12px;"><?php echo $notifCount; ?></span>
                <?php endif; ?>

                <div class="notif-dropdown hidden" id="notif-dropdown"
                    style="display: none; position:absolute; top:30px; right:0; background:white; border:1px solid #ccc; width:250px; max-height:300px; overflow-y:auto; box-shadow:0 0 5px rgba(0,0,0,0.2); z-index:100;">
                    <?php
                    if ($notifCount > 0) {
                    ...
                    <div class="popup-profile-picture">
                        ...
                        <div class="popup-picture-buttons"
                            ...
                            <form id="popupUploadForm" action="upload_profile_picture.php" method="POST"
                                ...
                                <input type="file" name="profile_picture" id="popupProfileInput" style="display: none;"
                                    onchange="document.getElementById('popupUploadForm').submit();">
                                <button type="button" onclick="document.getElementById('popupProfileInput').click();"
